...
func getSchemasHandler(c *gin.Context, database database.Database) ([]byte, error) {
	...
	schemas_view := views.MakeAllSchemas(schemas, common.Settings.AppNavbar.Links, common.Settings.AppNavbar.Dropdowns)
